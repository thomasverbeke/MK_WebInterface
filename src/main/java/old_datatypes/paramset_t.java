...
// defines for the receiver selection
    ...
    u8 NotGas;// Wert : 0-250     //Gaswert bei Emp??ngsverlust
    ...
    u8 LoopGasLimit;// Wert: 0-250  max. Gas w??hrend Looping
    u8 LoopThreshold;// Wert: 0-250  Schwelle f??r Stickausschlag
    u8 LoopHysterese;// Wert: 0-250  Hysterese f??r Stickausschlag
...
//        }
    ...
    public paramset_t(int index) {
        ...
        GlobalConfig = new u8Flags(index + " GlobalConfig", new String[]{"HOEHENREGELUNG", "HOEHEN_SCHALTER ", "HEADING_HOLD ", "KOMPASS_AKTIV ", "KOMPASS_FIX;", "GPS_AKTIV", "ACHSENKOPPLUNG_AKTIV", "DREHRATEN_BEGRENZER"});           // 0x01=H??henregler aktiv,0x02=Kompass aktiv, 0x04=GPS aktiv, 0x08=Heading Hold aktiv
        ...
        NotGas = new u8(index + " NotGas");                 // Wert : 0-250     //Gaswert bei Emp??ngsverlust
        ...
        LoopGasLimit = new u8(index + " LoopGasLimit");           // Wert: 0-250  max. Gas w??hrend Looping
        LoopThreshold = new u8(index + " LoopThreshold");          // Wert: 0-250  Schwelle f??r Stickausschlag
        LoopHysterese = new u8(index + " LoopHysterese");          // Wert: 0-250  Hysterese f??r Stickausschlag
